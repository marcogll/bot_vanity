...
class ServiceCatalog(Base):
    ...
    service_type: Mapped[str] = mapped_column(String(40), default="service", nullable=False)
    external_service_id: Mapped[str | None] = mapped_column(String(120), nullable=True)
    ...
    additional_time_minutes: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
